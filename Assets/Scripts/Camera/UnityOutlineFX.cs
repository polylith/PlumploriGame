...
/// <summary>
/// This class is used to highlight all parts of a
/// GameObject with a colored border.
/// This script must be placed on the main camera.
/// 
/// It is actually a script that comes originally
/// from Unity. It has been modified to meet the
/// specific needs.
/// </summary>
...
public class UnityOutlineFX : MonoBehaviour
{
    ...
    public void SetColor(int enabledState)
    {
        OutlineColor = colors[enabledState + 1];
    ...
    private void RecreateCommandBuffer()
    {
		...
		foreach (List<Renderer> collection in _objectRenderers)
        {
            id += 0.25f;
            ...
            {
                Renderer render = collection[i];
                _commandBuffer.DrawRenderer(render, _outlineMaterial, i, 2);
            }
        }
